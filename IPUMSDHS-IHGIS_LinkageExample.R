...
DHS_extract_data <- "ExerciseData/DHS_wLinking_idhs_00006.csv"
...
DHS_2011 <- read.csv(DHS_extract_data) %>% 
  ...
  select(IDHSPID, IDHSHID, DHSID, 
         ...
         HWHAZWHO,
         IHGISUG2009AGG2, IHGISUG2009AGG2P) %>% 
